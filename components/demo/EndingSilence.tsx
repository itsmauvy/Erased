  ...
  return (
    <div className="ending-wrap">
      <div className="text-area">
        ...
        {lineVisible && (
          <p className="line2">출석부에서 그 이름 하나가 빠져 있다.</p>
        )}
      </div>
      ...
      <style>{`
        .ending-wrap {
          position: fixed; inset: 0; background: #020304;
          display: flex; flex-direction: column; align-items: center; justify-content: center;
          padding: 40px 24px; animation: fadeIn 1.5s ease both; cursor: auto;
        }
        @keyframes fadeIn { from { opacity: 0; } to { opacity: 1; } }
        .text-area { max-width: 480px; width: 100%; text-align: center; }
        .days-later {
          font-family: var(--font-geist-mono), monospace;
          font-size: 0.7rem; letter-spacing: 0.25em; color: var(--ink-faint); margin-bottom: 24px;
        }
        .ending-title {
          font-family: var(--font-geist-mono), monospace; font-size: 2.5rem;
          letter-spacing: 0.5em; color: rgba(232,230,223,0.08); margin-bottom: 32px;
        }
        .line1, .line2 {
          font-family: var(--font-myeongjo), serif;
          font-size: 1rem; color: var(--ink-dim); line-height: 1.8; margin: 0 0 10px;
        }
        ...
        .restart-btn {
          ...
          transition: color 0.3s, border-color 0.3s; display: block;
        }
